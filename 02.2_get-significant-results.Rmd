...
unique(scott.sig.full.df$gene_name) %>% sort(.)
...
filter(scott.sig.full.df,replicated==TRUE)$gene_name %>% unique(.) %>% sort(.)
...
unique(scott.lws.full.df$gene_name) %>% sort(.)
...
filter(scott.lws.full.df,replicated==TRUE)$gene_name %>% unique(.) %>% sort(.)
...
unique(scottbmiadj.sig.full.df$gene_name) %>% sort(.)
...
unique(scottbmiadj.lws.full.df$gene_name) %>% sort(.)
